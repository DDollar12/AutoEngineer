...
5. In Paystack, set the callback URL to `https://YOUR-RENDER-DOMAIN.onrender.com/payments/callback` and the webhook URL to `https://YOUR-RENDER-DOMAIN.onrender.com/payments/webhook`.
